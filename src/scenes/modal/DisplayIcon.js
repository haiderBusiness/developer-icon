...
export default function DisplayIcon({IconFunc}) {

    return(
        <div className={styles.nameAndIcon}>
                    
            <div>
                <div className={styles.iconName}>{IconFunc && IconFunc.name ? IconFunc.name : "Blumb with which is looking lightning"}
                </div>
            ...
            {IconFunc ? <IconFunc fontSize={40} className={styles.icon} /> : null}
